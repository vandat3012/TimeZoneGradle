package com.example.timenowgradle.controller;
...
public class TimeController {
    ...
    public String getTimeByZone (@RequestParam(name = "city",required = false,defaultValue = "Asia/Ho_Chi_Minh")String city, ModelMap modelMap) {
